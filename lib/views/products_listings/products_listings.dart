...
class _ProductListingScreenState extends State<ProductListingScreen> {
  ...
  void _initializeFilters() {
    ...
    currentCategory = currentFilters['category'] ?? widget.initialCategory;
    ...
    showModalBottomSheet(
      ...
      builder: (context) {
        return SizedBox(
          ...
          child: BrowseFilterScreen(initialFilters: currentFilters, mainRoute: false,),
        );
      },
    ).then((result) {
      if (result != null && result is Map<String, dynamic>) {
        setState(() {
          ...
          currentCategory = result['category'] ?? currentCategory;
                    ...
                    return ListTile(
                      ...
                      trailing:
                          currentCategory == category
                              ? Icon(Icons.check, color: Color(0xFFF3B340))
                              : null,
                      onTap: () {
                        setState(() {
                          currentCategory = category;
  ...
  Widget _buildFilterChip(String label, VoidCallback onRemove) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(color: Color(0xFFF3B340)),
      ),
      child: Row(
        mainAxisSize: MainAxisSize.min,
        children: [
          ...
          GestureDetector(
            onTap: onRemove,
            child: Icon(Icons.close, size: 14, color: Color(0xFFF3B340)),
          ),
        ],
      ),
    );
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          // Listings Grid
          Expanded(
            child: StreamBuilder<List<ListingWrapper>>(
              stream: _listingsStream,
              builder: (context, snapshot) {
                ...
                if (!snapshot.hasData || snapshot.data!.isEmpty) {
                  return _buildEmptyState(
                    searchQuery.isNotEmpty
                        ...
                        : 'No ${_getPluralListingType(listingType)} found in $currentCategory\nBe the first to list something!',
                    context,
                  );
                }
      ...
      if (mounted) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            ...
            backgroundColor: newFavoriteStatus ? Color(0xffF3B340) : Colors.red,
          ),
        );
      ...
      appBar: AppBar(
        ...
        title: Row(
          children: [
            ...
            Text(
              widget.business.businessCategory ?? 'General',
              style: TextStyle(
                color: Color(0xFFF3B340),
                fontSize: 16,
                fontWeight: FontWeight.normal,
              ...
              child: Stack(
                children: [
                  PageView.builder(
                    ...
                    itemCount: widget.business.photoUrls?.length ?? 1,
                    itemBuilder: (context, index) {
                      return Container(
                  ...
                  if (widget.business.photoUrls != null &&
                      widget.business.photoUrls!.length > 1)
                    Positioned(
                      bottom: 30,
                      left: 0,
                      right: 0,
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 8),
                  Text(
                    'Contact business for operating hours',
                    style: TextStyle(color: Colors.grey[600], fontSize: 14),
                  ),
                  SizedBox(height: 24),
                  ...
                  SizedBox(height: 12),
                  Text(
                    'Contact business directly for inquiries',
                    style: TextStyle(color: Colors.grey[600], fontSize: 14),
                  ),
                  SizedBox(height: 32),
      ...
      appBar: AppBar(
        ...
        title: Row(
          children: [
            ...
            Text(
              widget.event.eventCategory ?? 'General',
              style: TextStyle(
                color: Color(0xFFF3B340),
                fontSize: 16,
                fontWeight: FontWeight.normal,
              ...
              child: Stack(
                children: [
                  PageView.builder(
                    ...
                    itemCount: widget.event.photoUrls?.length ?? 1,
                    itemBuilder: (context, index) {
                      return Container(
                        margin: EdgeInsets.all(16),
                        decoration: BoxDecoration(
                          ...
                          children: [
                            Center(
                              child: ClipRRect(
                                borderRadius: BorderRadius.circular(12),
                                child:
                                    widget.event.photoUrls != null &&
                                            widget.event.photoUrls!.isNotEmpty
                                        ? Image.network(
                  ...
                  // Image indicator dots
                  if (widget.event.photoUrls != null &&
                      widget.event.photoUrls!.length > 1)
                    Positioned(
                      bottom: 30,
                      left: 0,
                      right: 0,
              ...
              child: Stack(
                children: [
                  PageView.builder(
                    ...
                    itemCount: widget.product.photoUrls?.length ?? 1,
                    itemBuilder: (context, index) {
                      return Container(
                        margin: EdgeInsets.all(16),
                        decoration: BoxDecoration(
                        ...
                        child: Stack(
                          children: [
                            ...
                            // Favorite Button using the new FavoriteButton widget
                            Positioned(
                              top: 16,
                              right: 16,
                              child: FavoriteButton(
                  ...
                  // Image indicator dots
                  if (widget.product.photoUrls != null &&
                      widget.product.photoUrls!.length > 1)
                    Positioned(
                      bottom: 30,
                      left: 0,
                      right: 0,
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 12),
                  Text(
                    'Email : arfbeatle@gmail.com',
                    style: TextStyle(color: Colors.grey[600], fontSize: 14),
                  ),
                  SizedBox(height: 8),
                  Text(
                    'Shipping / Pickup : (845) 987-4943',
                    style: TextStyle(color: Colors.grey[600], fontSize: 14),
                  ),
                  SizedBox(height: 32),
